...
use crate::World;
use crate::generate::util::{latitude_factor, ridge_noise, smoothstep};
...
pub(super) fn relax_terrain(world: &World, fields: &OrogenFields, terrain: &mut Vec<f32>) {
...
pub(super) fn apply_tectonic_equilibrium(
    world: &World,
    ridge: &OpenSimplex,
    fields: &OrogenFields,
    terrain: &mut Vec<f32>,
